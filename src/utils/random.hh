...
public:
    UniformDistribution(const std::default_random_engine &gen, const std::uniform_real_distribution<float> dis): gen(gen), dis(dis) {}
...
public:
    NormalDistribution(const std::default_random_engine &gen, const std::normal_distribution<float> dis): gen(gen), dis(dis) {}
